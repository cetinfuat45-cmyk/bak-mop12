        ...
        validDocs.forEach(item => {
            ...
            if (data.interventions && Array.isArray(data.interventions) && data.interventions.length > 0) {
                bakimLogu = data.interventions
                    ...
                    // V4.1.1 standart log önceliği
                    if (inv.logAction) {
                        actionStr = inv.logAction;
                    ...
                    // Ana operatör durumları
                        ...
                        else if (inv.status === 'Parça Bekliyor') actionStr = "PARÇA BEKLİYOR DURUMUNA ALDI";
                        else if (inv.status === 'Dış Servis Bekliyor') actionStr = "DIŞ SERVİS BEKLİYOR DURUMUNA ALDI";
                ...
                const totalDuration = data.durationMin || 0;
            }
